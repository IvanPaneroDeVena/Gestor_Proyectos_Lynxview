...
interface HorasEquipoMensualTableProps {
  month: string
  year: string
}

export function HorasEquipoMensualTable({ month, year }: HorasEquipoMensualTableProps) {
  const [sortColumn, setSortColumn] = useState("nombre")
  const [sortDirection, setSortDirection] = useState<"asc" | "desc">("asc")

  // Datos de ejemplo para las horas mensuales por miembro del equipo
  const horasEquipoData = [
    {
      ...
      utilizacion: 97,
      proyectos: [
        { nombre: "Portal cliente Banco Nacional", horas: 45, id: "PRJ001" },
        { nombre: "App móvil Seguros Unidos", horas: 50, id: "PRJ003" },
    ...
    },
    {
      ...
      utilizacion: 91,
      proyectos: [
        { nombre: "Portal cliente Banco Nacional", horas: 35, id: "PRJ001" },
        { nombre: "Plataforma e-learning", horas: 40, id: "PRJ002" },
    ...
    },
    {
      ...
      utilizacion: 94,
      proyectos: [
        { nombre: "Portal cliente Banco Nacional", horas: 40, id: "PRJ001" },
        { nombre: "App móvil Seguros Unidos", horas: 60, id: "PRJ003" },
    ...
    },
    {
      ...
      utilizacion: 103,
      proyectos: [
        { nombre: "Plataforma e-learning", horas: 45, id: "PRJ002" },
        { nombre: "App móvil Seguros Unidos", horas: 40, id: "PRJ003" },
        { nombre: "Migración Base de Datos", horas: 30, id: "PRJ005" },
    ...
    },
    {
      ...
      utilizacion: 88,
      proyectos: [
        { nombre: "Portal cliente Banco Nacional", horas: 30, id: "PRJ001" },
        { nombre: "Plataforma e-learning", horas: 25, id: "PRJ002" },
        { nombre: "App móvil Seguros Unidos", horas: 35, id: "PRJ003" },
  ...
  return (
    <div className="rounded-md border bg-white">
      <div className="p-4 border-b">
        <h3 className="text-lg font-medium">Horas Mensuales por Miembro del Equipo</h3>
        <p className="text-sm text-gray-500">
          Desglose de horas registradas en {month}/{year} por cada miembro del equipo
        </p>
      </div>
      <TooltipProvider>
        <Table>
